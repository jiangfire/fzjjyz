...
欢迎贡献 fzj 项目！本文档将帮助您了解如何参与项目开发、提交代码和改进文档。
...
```bash
# 1. Fork 项目
# 访问 https://codeberg.org/jiangfire/fzj
# 点击 Fork 按钮

# 2. 克隆你的 Fork
git clone https://codeberg.org/your-username/fzj
cd fzj

# 3. 添加上游仓库
git remote add upstream https://codeberg.org/jiangfire/fzj
...
# 测试
go test -cover ./...
go test -v -run TestEncrypt ./cmd/fzj/

# 构建发布
go build -ldflags="-s -w" -o fzj ./cmd/fzj

# 跨平台
GOOS=windows GOARCH=amd64 go build -o fzj.exe ./cmd/fzj
```
...
2. 🔍 浏览 [Issues](https://codeberg.org/jiangfire/fzj/issues) 找感兴趣的任务
3. 💬 加入讨论，提出你的想法
4. 🚀 提交你的第一个 PR！
...
**问题？** 查看 [FAQ](https://codeberg.org/jiangfire/fzj/discussions) 或创建 Issue
